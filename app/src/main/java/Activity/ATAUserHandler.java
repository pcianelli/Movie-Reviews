...
public class ATAUserHandler {
    ...
    public int getInteger(String message) {
        return this.getInteger(Integer.MIN_VALUE, Integer.MAX_VALUE, message);
    }
    ...
    public long getLong(String message) {
        return this.getLong(Long.MIN_VALUE, Long.MAX_VALUE, message);
    }
    ...
    public double getDouble(String message) {
        return this.getDouble(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, message);
    }
